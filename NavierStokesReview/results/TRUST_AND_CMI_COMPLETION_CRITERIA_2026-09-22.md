...
| Transitive kernel axioms | Pending: cache restored, but bounded target build did not emit target `.olean` | `NavierStokesReview/results/BUILD_AND_AXIOM_EXTRACTION_LOG_2026-09-22.md`; `AXIOM_PROBE_4_34_RC2.txt` |

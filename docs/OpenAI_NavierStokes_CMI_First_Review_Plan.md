...
| Release            | Commit and push the final selected-field audit update.                                                                     | [x] Commit `0dc5aab` is ready for push to `review/cmi-first-navier-stokes-2026-09-22`; the two supplied PDFs and existing scratch file remain intentionally untracked. |
